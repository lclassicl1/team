...
public class CommentDAO {
	...
	public Comment selectByNo(Connection conn,int commNo)throws SQLException {
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		String sql ="select * from trade_comment where comm_no=?";
	...
	public int commentCount(Connection conn,int no)throws SQLException {
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		String sql = "select count(*) from trade_comment where isshow='Y' and article_no=? ";
	...
	public void isshow(Connection conn, int commNo)throws SQLException {
		PreparedStatement pstmt = null;
		String sql = "update trade_comment set isshow='N' where comm_no=?";
