...
import tradecomment.service.WriteCommentService;
import mvc.command.CommandHandler;

public class WriteCommentHandler implements CommandHandler {

	private static final String FORM_VIEW= "/view/tradeboard/readTrade.jsp";
	...
	private String processSubmit(HttpServletRequest req, HttpServletResponse res) throws Exception {
		...
		return "/view/tradeboard/writeCommentSuccess.jsp";
	}
