...
public class Review {
	...
	private String review_category;//카테고리
	

	public Review(Integer review_number, Review_Writer review_writer, String review_title, Date review_credate,
			Date review_update, int review_read_cnt, String review_isshow, String review_category) {
		super();
	...
	public String toString() {
		return "Review [review_number=" + review_number + ", review_writer=" + review_writer + ", review_title="
				...
				+ ", review_read_cnt=" + review_read_cnt + ", review_isshow=" + review_isshow + ", review_category="
				+ review_category + "]";
	}
