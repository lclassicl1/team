...
import reviewComment.service.ModifyCommentService;
...
public class ModifyCommentHandler implements CommandHandler {
	...
	private static final String FORM_VIEW = "/view/reviewboard/modifyCommForm.jsp";
	...
	private String processSubmit(HttpServletRequest req, HttpServletResponse res) throws Exception {
		...
		try {
			...
			return "/view/reviewboard/modifyCommSuccess.jsp";
		}catch(CommentNotFoundException e) {
